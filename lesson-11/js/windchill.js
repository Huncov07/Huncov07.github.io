...
if (tempH < 51 && wSpeed > 3) {
	let wChill =
		...
		0.4275 * tempH * Math.pow(wSpeed, 0.16);
...
let day1 = (document.getElementById("nameDay1").innerText =
	weekday[nextdayList[0]]);
let day2 = (document.getElementById("nameDay2").innerText =
	weekday[nextdayList[1]]);
let day3 = (document.getElementById("nameDay3").innerText =
	weekday[nextdayList[2]]);
let day4 = (document.getElementById("nameDay4").innerText =
	weekday[nextdayList[3]]);
let day5 = (document.getElementById("nameDay5").innerText =
	weekday[nextdayList[4]]);
