...
const apiURL =
	"https://api.openweathermap.org/data/2.5/weather?id=5585010&units=imperial&appid=c704063b98daaa9a962869e196e217ee";
...
const apiURLforecast =
	"https://api.openweathermap.org/data/2.5/forecast?id=5585010&units=imperial&appid=c704063b98daaa9a962869e196e217ee";
fetch(apiURLforecast)
	...
	.then((jsObject) => {
		...
		for (let i = 3; i < forecast.length; i += 8) {
			...
			document.getElementById(`tempForecast${i}`).innerText =
